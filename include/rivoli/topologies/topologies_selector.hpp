...
template <typename FP, vectra::SIMDLevel level>
struct TopologyTraits<3, false, false, CoordinateSystem::Spherical, FP, level> {
	using type = Topology1Rx2SEuclidean<FP, level>;
};

template <typename FP, vectra::SIMDLevel level>
struct TopologyTraits<3, true, false, CoordinateSystem::Spherical, FP, level> {
	using type = Topology1Rx2SBilateralEuclidean<FP, level>;
};

template <typename FP, vectra::SIMDLevel level>
struct TopologyTraits<3, false, true, CoordinateSystem::Spherical, FP, level> {
	using type = Topology1Rx2SReciprocalEuclidean<FP, level>;
};

template <typename FP, vectra::SIMDLevel level>
struct TopologyTraits<3, true, true, CoordinateSystem::Spherical, FP, level> {
	using type = Topology1Rx2SBilateralReciprocalEuclidean<FP, level>;
};

template <typename FP, vectra::SIMDLevel level>
struct TopologyTraits<3, false, false, CoordinateSystem::Rusinkiewicz, FP, level> {
...
template <typename FP, vectra::SIMDLevel level>
struct TopologyTraits <3, false, true, CoordinateSystem::Rusinkiewicz, FP, level> {
	using type = Topology1Rx2SReciprocalRusinkiewiczEuclidean<FP, level>;
};

template <typename FP, vectra::SIMDLevel level>
struct TopologyTraits <3, true, false, CoordinateSystem::Rusinkiewicz, FP, level> {
...
template <typename FP, vectra::SIMDLevel level>
struct TopologyTraits <3, true, true, CoordinateSystem::Rusinkiewicz, FP, level> {
	using type = Topology1Rx2SBilateralReciprocalRusinkiewiczEuclidean<FP, level>;
};
